...
{
    public class BigAxolotlGills : LongBodyScales
    {
        public BigAxolotlGills(LizardGraphics lGraphics, int startSprite)
        : base(lGraphics, startSprite)
        {
            ...
            for (int i = 0; i < num2; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    ...
                    scaleObjects[i * 2 + j].length = Mathf.Lerp(15f, 35f, num * num5);
